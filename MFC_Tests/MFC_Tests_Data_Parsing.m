...
%% Enter data 
% date and info
addinfo = "11/18/2022 - Board0 - NO, RH Permselect 0.5%O2"; %enter any information about this test bthat is not contained in the headerfile
chip = 23; %enter chip number (E.G. 1 for AMES1, etc.)
