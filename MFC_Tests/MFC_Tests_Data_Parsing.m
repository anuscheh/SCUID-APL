...
%% Enter data 
% date and info
addinfo = "09/29/2022 -Board2 - NO, Dry"; %enter any information about this test bthat is not contained in the headerfile
chip = 15; %enter chip number (E.G. 1 for AMES1, etc.)
